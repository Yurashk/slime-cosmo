 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function en(e=Ce()){e=b(e);const t=E(e,C);return t.isInitialized()?t.getImmediate():Wt(e)}function Wt(e,t={}){const n=E(e,C);if(n.isInitialized()){const i=n.getImmediate();if(Ee(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function tn(){if(X()||!Q()||!Z())return!1;try{return await ee()}catch{return!1}}function nn(e,t,n){e=b(e),Lt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}async function an(e){return e=b(e),Ut(g,p[e.app.options.appId])}function rn(e,t,n){e=b(e),qt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function Yt(e,t,n){e=b(e),jt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function sn(e,t){e=b(e),Bt(p[e.app.options.appId],t).catch(n=>u.error(n))}function on(e){g?g("set",e):ve(e)}function Jt(e,t,n,a){e=b(e),xt(g,p[e.app.options.appId],t,n,a).catch(i=>u.error(i))}function cn(e){g?g("consent","update",e):Ae(e)}const K="@firebase/analytics",W="0.10.25";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
